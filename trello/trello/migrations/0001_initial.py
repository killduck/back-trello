    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.IntegerField(error_messages={'unique': 'Номер позиции повторяется'}, help_text='Введите номер позиции', null=True, unique=True, verbose_name='Номер позиции колонки')),
            ],
            options={
