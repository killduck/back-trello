# Generated by Django 5.0.4 on 2024-05-18 13:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Введите наименование категории', max_length=50, verbose_name='Наименование колонки')),
                ('order', models.IntegerField(error_messages={'unique': 'Номер позиции повторяется'}, help_text='Введите номер позиции', unique=True, verbose_name='Номер позиции колонки')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('column', models.ForeignKey(blank=True, help_text='Введите колонку к которой относится карточка', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='cards', to='trello.columns', verbose_name='Колонка')),
